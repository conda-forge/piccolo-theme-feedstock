...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/piccolo-theme-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15539&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/piccolo-theme-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `piccolo-theme` can be installed with:

```
conda install piccolo-theme
```

It is possible to list all of the versions of `piccolo-theme` available on your platform with:
